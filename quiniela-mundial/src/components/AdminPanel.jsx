...
export default function AdminPanel({ 
  ...
  const [activeTab, setActiveTab] = useState('A'); // Pestañas 'A'..'H', 'knockout' o 'users'
  ...
  const handleCopyEmails = () => {
    ...
    const emails = usersList.map(u => u.email).join(', ');
    navigator.clipboard.writeText(emails);
    if (showToast) showToast('📋 ¡Todos los correos copiados al portapapeles!', 'success');
  };
  ...
  return (
    <div className="fade-in admin-card">
      ...
      <div className="glass-card">
        ...
        {/* VISTAS DE GRUPOS (Pestañas A..H) */}
        {activeTab !== 'knockout' && activeTab !== 'users' && (
          <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem', marginBottom: '1.5rem' }}>
              <div>
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.8rem' }}>
                  Gestiona los permisos y copia las listas de correos de los usuarios registrados.
                </p>
              </div>
              ...
              >
                📋 Copiar Lista de Correos ({usersList.length})
              </button>
            </div>
